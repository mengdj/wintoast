	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_WINTOAST, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINTOAST));
	//
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINTOAST));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_WINTOAST);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
	{
		...
		case IDM_ABOUT:
			...
			break;
		case IDM_EXIT:
			xmstudio::toast::show(hWnd, TEXT("停留1.5秒(窗口2)"), 1500, 0, 0);
			//DestroyWindow(hWnd);
			break;
		default:
